...
const { generateAIAnswer, generateAIFAQ } = require('./controllers/aiController');
...
app.post('/api/answer', protect, validateAIAnswer, generateAIAnswer);
app.post('/api/generate-faq', protect, validateAIFaq, generateAIFAQ);
